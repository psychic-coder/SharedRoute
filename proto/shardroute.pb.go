...
var file_proto_shardroute_proto_goTypes = []any{
	(*CheckRequest)(nil),  // 0: shardroute.v1.CheckRequest
	(*CheckResponse)(nil), // 1: shardroute.v1.CheckResponse
}
var file_proto_shardroute_proto_depIdxs = []int32{
	0, // 0: shardroute.v1.RateLimiter.Check:input_type -> shardroute.v1.CheckRequest
	0, // 1: shardroute.v1.RateLimiter.StreamCheck:input_type -> shardroute.v1.CheckRequest
	1, // 2: shardroute.v1.RateLimiter.Check:output_type -> shardroute.v1.CheckResponse
	1, // 3: shardroute.v1.RateLimiter.StreamCheck:output_type -> shardroute.v1.CheckResponse
